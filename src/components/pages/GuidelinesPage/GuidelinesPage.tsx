...
export const GuidelinesPage: React.FC = () => {
  ...
  const designPrinciples = [
    {
      ...
      description: "Use established patterns and tokens throughout the system. When in doubt, choose the existing solution over creating something new.",
      icon: "🎯"
    },
    {
      title: "Accessibility by Default", 
      description: "Every component and pattern must meet WCAG 2.1 AA standards. Design for all users from the start, not as an afterthought.",
      icon: "♿"
    },
    {
      title: "Progressive Enhancement",
      description: "Start with basic functionality and enhance with advanced features. Ensure core experiences work for everyone.",
      icon: "📈"
    },
    {
      title: "Banking Trust",
      description: "Prioritize clarity, security indicators, and error prevention. Users must feel confident about financial actions.",
      icon: "🏦"
    }
  ];
  ...
  return (
    <PageTemplate
      ...
      description="Core principles, token architecture, and best practices for building consistent, accessible experiences with the M1st Design System."
      showSidebar={false}
      sidebarType="none"
    >
      <div className="max-w-6xl space-y-12">
        ...
        <section>
          ...
          <p className="text-lg mb-8" style={{ color: 'var(--page-text-secondary)' }}>
            These core principles guide every design decision in the M1st Design System.
          </p>
        ...
        <section>
          ...
          <p className="text-lg mb-8" style={{ color: 'var(--page-text-secondary)' }}>
            Our 4-layer token system ensures scalability, consistency, and maintainability across all design decisions.
          </p>
        ...
        <section>
          ...
          <p className="text-lg mb-8" style={{ color: 'var(--page-text-secondary)' }}>
            Our architecture aligns with industry leaders. Here's how major design systems structure their tokens:
          </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-sm" style={{ color: 'var(--page-text-secondary)' }}>
                      ...
                      <li>• Test with multiple themes before shipping</li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm" style={{ color: 'var(--page-text-secondary)' }}>
                      ...
                      <li>• Don't assume light theme only</li>
                      <li>• Avoid breaking established patterns</li>
                    </ul>
                  </div>
                </div>
